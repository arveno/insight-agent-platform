...
readonly EXPECTED_VERIFY_LINES=(
  "tables=27"
  "users.row_count=1"
  "workspaces.row_count=2"
  "workspace_memberships.row_count=2"
  "data_sources.row_count=4"
  "data_tables.row_count=6"
  "knowledge_documents.row_count=3"
  "metrics.china.row_count=4"
  "metrics.sea.row_count=2"
  "metric_context_sources.row_count=12"
  "auth_sessions.seedUser.exists=1"
  "auth_sessions.validSeedUserSession.exists=1"
  ...
  "feedback.row_count=0"
  "evaluation_datasets.row_count=0"
  "evaluation_runs.row_count=0"
  "evaluation_scores.row_count=0"
  "bad_cases.row_count=0"
  "messages.row_count=0"
  "messages.analysisTaskIdColumn.exists=1"
  "messages.submitUserMessageMissingAnalysisTaskId.row_count=0"
  "message_streams.row_count=0"
  "user.userId=user-zoe"
  "workspace.primary.workspaceId=workspace-northstar-retail-china"
  "workspace.secondary.workspaceId=workspace-northstar-retail-sea"
  "membership.primary.role=analyst"
  "membership.secondary.role=viewer"
  "analysisTaskId=analysis-task-revenue-gap-q2"
  "analysisTask.conversationId=conversation-revenue-gap-q2"
  ...
  "analysisTask.contextPack.root.kind=dashboardOverview"
  "analysisTask.contextPack.reportId=report-weekly-business"
  "analysisRun.status=created"
  "analysisRun.phase=intake"
  "metric.recognizedRevenue.exists=1"
  "metric.grossMargin.exists=1"
  "metric.refundRate.exists=1"
  "metric.inventoryTurnover.exists=1"
  "metric.seaRecognizedRevenue.exists=1"
  "metric.seaDeliveryDelayRate.exists=1"
  "metricContextSources.recognizedRevenue.exists=1"
  "metricContextSources.seaDeliveryDelay.exists=1"
  "metricContextSources.unresolved.row_count=0"
  "dataTables.unresolvedDataSource.row_count=0"
  "sourceEvidence.unresolvedRun.row_count=0"
  "sourceEvidence.unresolvedSource.row_count=0"
  "sourceEvidence.invalidLifecycle.row_count=0"
  "reports.unresolvedRun.row_count=0"
  "reports.unresolvedSourceEvidence.row_count=0"
