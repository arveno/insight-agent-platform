...
const backendFiles = [
  ...
  "services/agent-runtime/src/modules/agent-runs/evaluation_service.py",
  "services/agent-runtime/src/modules/agent-runs/observability_service.py",
  "services/agent-runtime/src/modules/agent-runs/regression.py",
  "services/agent-runtime/src/modules/data-knowledge/data_source_service.py",
  "services/agent-runtime/src/modules/data-knowledge/knowledge_service.py",
  "services/agent-runtime/src/modules/model-tools/model_tool_service.py",
  ...
  "services/agent-runtime/src/modules/platform-operations/platform_operation_service.py",
  "services/agent-runtime/src/infrastructure/model-gateway/gateway.py",
  "services/agent-runtime/src/infrastructure/model-gateway/routing.py",
  "services/agent-runtime/src/infrastructure/model-gateway/cost.py",
  "services/agent-runtime/src/infrastructure/model-gateway/errors.py",
  "services/agent-runtime/src/infrastructure/tool-registry/registry.py",
  "services/agent-runtime/src/infrastructure/tool-registry/sql_tool.py",
  "services/agent-runtime/src/infrastructure/tool-registry/metric_tool.py",
  "services/agent-runtime/src/infrastructure/tool-registry/memory_tool.py",
  "services/agent-runtime/src/infrastructure/tool-registry/report_tool.py",
  "services/agent-runtime/src/infrastructure/tool-registry/mcp_adapter.py",
