...
import { RouteActionBar } from "../router/RouteActionBar";
import type { NavigateToRoute } from "../router/pageProps";
import type { StaticPageViewModelBase } from "./models/staticViewModelTypes";
        ...
        <PageHeader
          actions={
            hideHeaderActions ? undefined : (
              <RouteActionBar actions={actions} onNavigate={onNavigate} t={t} />
            )
          }
          meta={
            <Space wrap>
