import type { StaticPageStateViewModel, StaticPageViewModelBase, StaticSummaryItemViewModel, StaticTraceEntranceViewModel } from "../../../app/models/staticViewModelTypes";
