import { createRightAssistSummary, defaultPermissionSummary, defaultReadonlyState, defaultStateCoverage, readyStatus, sharedTraceEntrances, warningRisk } from "../../../app/fixtures/staticStateFixtures";
